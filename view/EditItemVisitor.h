...
public:
    EditItemVisitor(QLineEdit* nameEdit, QTextEdit* descriptionEdit, QLineEdit* versionEdit, QCheckBox* winCompatibilityCheck, QLineEdit* developerEdit,
                    ...
                    QCheckBox* standaloneCheck, QLineEdit* composerEdit, QLineEdit* tracksNumberEdit, QString selectedImagePath);
